#!/usr/bin/env python3
"""Test: layer45-agent (graph tools approach) on django-10880 with SAME vague ticket"""
import os, sys, time
...
print("=" * 70)
print("  LAYER45-AGENT (35 tools + graph) — Same SQL bug, same vague ticket")
print("=" * 70)

ticket = Ticket(ticket_id="VAGUE-SQL-001", title=TITLE, body=BODY, repo_id="django/django")
...
if impl and impl.file_results:
    print(f"  Files changed: {[fr.file_path for fr in impl.file_results]}")
